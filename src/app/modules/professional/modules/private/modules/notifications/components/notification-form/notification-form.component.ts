...
import {
  FormDataModel,
  generateFormData,
} from '../../../../../../../../utils/functions/generate-form-data.function';
  ...
  implements OnInit
{
  ...
  constructor(
    ...
    this.familyId = this.form.get('familyId') as FormControl;
  }
  ...
  addEventForm(): void {
    this.form.controls.allFamily.valueChanges.subscribe((value) => {
      if (value == true) this.form.controls.familyId.disable();
      else this.form.controls.familyId.enable();
    });
  }
